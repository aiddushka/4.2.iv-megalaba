Рекомендации + Задачи
1. Изменение конфигурации в http://localhost:3000/dashboard очень хорошее, точно такое же нужно сделать и в http://localhost:3001.
2. Второе что нужно сделать у каждого устройства стоят уникальные описания, только для этого устройства
